...
taskManager =
	"~/.config/hypr/hyprland/scripts/launch_first_available.sh 'plasma-systemmonitor --page-name Processes' 'gnome-system-monitor' 'command -v btop && kitty -1 fish -c btop'"
